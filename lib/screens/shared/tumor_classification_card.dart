...
class TumorClassificationCard extends StatefulWidget {
  ...
  @override
  State<TumorClassificationCard> createState() =>
      _TumorClassificationCardState();
}

class _TumorClassificationCardState extends State<TumorClassificationCard> {

...
import '../shared/xray_upload_screen.dart';
            ...
            children: [
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Welcome back,', style: AppText.caption),
                          Text(firstName,
              ...
              FadeSlideIn(
                ...
                child: Padding(
                  ...
                  child: _HeroCta(accent: _accent, onTap: _goToScan),
                ),
              ),
              const SizedBox(height: 28),
              ...
              Padding(
                ...
                child: FadeSlideIn(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text('Recent Scans', style: AppText.headingMd),
                      Text('your history',
                ...
                child: FadeSlideIn(
                  ...
                  child: uid.isEmpty
                      ...
                      : StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                          stream: db.getAnalysesStream(uid),
                          builder: (context, snap) {
                            ...
                            if (docs.isEmpty) return const _EmptyScans();
                            return ListView.separated(
                              ...
                              itemBuilder: (context, i) => _ScanCard(
                                  data: docs[i].data(), accent: _accent),
                            );
                          },
                        ),
                ),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  const Text('Chest Cancer\nDetection',
                      style: AppText.displayMd),
                  const SizedBox(height: 8),
                  Text(
                    'Upload a chest X-ray to receive an\ninstant AI-driven analysis.',
...
class _ScanCard extends StatelessWidget {
  ...
  final Color accent;
  const _ScanCard({required this.data, required this.accent});
  ...
  Widget build(BuildContext context) {
    ...
    final diagColor = isNormal ? AppColors.success : AppColors.warning;
        ...
        Expanded(
          child: Column(
            ...
            children: [
              Text(diagnosis,
                  style: AppText.headingMd
                      .copyWith(color: diagColor, fontSize: 14),
                  overflow: TextOverflow.ellipsis),
        ...
        child: Column(
          ...
          children: [
            Icon(Icons.image_search_rounded,
                size: 64,
                color:
                    AppColors.patientPrimary.withValues(alpha: 0.25)),
            ...
            const SizedBox(height: 8),
            Text(
              'Upload a chest X-ray to get your first AI analysis.',
              style: AppText.bodySm,
